...
O ~\nameref{sigla:DER} do software de Licenças é apresentado na Figura \ref{fig:figura2}: 
...
De acordo com o \nameref{sigla:DER} apresentado na Figura \ref{fig:figura2}, a tabela \verb|empresa| está relacionada às empresas que irão receber a licença de uso. Geralmente são clientes ou outras empresas parceiras (software-houses), a tabela \verb|filial| indica as filiais que uma empresa pode ter. Cada registro de filial está relacionada com um e apenas um registro de empresa.
