...
Segundo Harrold e Rothermel (1994), no Teste Funcional intra-classe são testadas as interações entre os métodos públicos fazendo chamada a esses métodos em diferentes sequências. É a integração entre os métodos da mesma classe. 
...
Souza (2008)\cite{Souza} realizou um estudo com bases nesses critérios, foram apresentados critérios que fazem parte do fluxo funcional intra-classe e fluxo funcional inter-classe . São eles:
