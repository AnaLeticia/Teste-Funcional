...
Segundo Harrold e Rothermel (1994)\cite{HarroldRothermel}, no Teste Funcional intra-classe são testadas as interações entre os métodos públicos fazendo chamada a esses métodos em diferentes sequências. É a integração entre os métodos da mesma classe. 
...
Juliana Souza (2008)\cite{Souza} Realizou um estudo com bases nesses critérios, foram apresentados critérios que fazem parte do fluxo funcional intra-classe e fluxo funcional inter-classe . São eles:
...
De acordo com (Tuya et al, 2006\cite{Tuya2006}), técnicas de teste de mutação, ajudam o testador a criar dados de teste e avaliar a sua adequação através da inserção sistemática de falhas artificiais em um determinado programa e, em seguida, avaliar a porcentagem de falhas que são detectadas por um determinado conjunto de testes. 
...
Existem outros subtipos listados em (Tuya, et al, 2006)\cite{Tuya2006} que não serão apresentados neste trabalho como exemplo. Para execução dos testes usaremos estes que foram listados acima.