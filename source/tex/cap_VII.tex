...
As Figuras \ref{fig:resultadoIntraTabelas1} a \ref{fig:resultadoIntraTabelas21} apresentam os resultados obtidos.

Os Scripts dos testes executados são apresentados no Apêndice \ref{apend:B}, ao final desse Trabalho.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/1}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/2}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/3}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/4}
	\caption{Resultados da execução dos testes Intra-tabelas 4}
	\label{fig:resultadoIntraTabelas4}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/5}
	\caption{Resultados da execução dos testes Intra-tabelas 5}
	\label{fig:resultadoIntraTabelas5}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/6}
	\caption{Resultados da execução dos testes Intra-tabelas 6}
	\label{fig:resultadoIntraTabelas6}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/7}
	\caption{Resultados da execução dos testes Intra-tabelas 7}
	\label{fig:resultadoIntraTabelas7}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/8}
	\caption{Resultados da execução dos testes Intra-tabelas 8}
	\label{fig:resultadoIntraTabelas8}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/9}
	\caption{Resultados da execução dos testes Intra-tabelas 9}
	\label{fig:resultadoIntraTabelas9}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/10}
	\caption{Resultados da execução dos testes Intra-tabelas 10}
	\label{fig:resultadoIntraTabelas10}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/11}
	\caption{Resultados da execução dos testes Intra-tabelas 11}
	\label{fig:resultadoIntraTabelas11}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/12}
	\caption{Resultados da execução dos testes Intra-tabelas 12}
	\label{fig:resultadoIntraTabelas12}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/13}
	\caption{Resultados da execução dos testes Intra-tabelas 13}
	\label{fig:resultadoIntraTabelas13}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/14}
	\caption{Resultados da execução dos testes Intra-tabelas 14}
	\label{fig:resultadoIntraTabelas14}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/15}
	\caption{Resultados da execução dos testes Intra-tabelas 15}
	\label{fig:resultadoIntraTabelas15}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/16}
	\caption{Resultados da execução dos testes Intra-tabelas 16}
	\label{fig:resultadoIntraTabelas16}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/17}
	\caption{Resultados da execução dos testes Intra-tabelas 17}
	\label{fig:resultadoIntraTabelas17}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/18}
	\caption{Resultados da execução dos testes Intra-tabelas 18}
	\label{fig:resultadoIntraTabelas18}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/19}
	\caption{Resultados da execução dos testes Intra-tabelas 19}
	\label{fig:resultadoIntraTabelas19}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/20}
	\caption{Resultados da execução dos testes Intra-tabelas 20}
	\label{fig:resultadoIntraTabelas20}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/intra-tabelas/21}
	\caption{Resultados da execução dos testes Intra-tabelas 21}
	\label{fig:resultadoIntraTabelas21}
\end{figure}
...
As Figuras \ref{fig:resultadoInterTabelas1} a \ref{fig:resultadoInterTabelas3} apresentam os resultados obtidos.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/inter-tabelas/1}
	\caption{Resultados da execução dos testes Inter-tabelas 1}
	\label{fig:resultadoInterTabelas1}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/inter-tabelas/2}
	\caption{Resultados da execução dos testes Inter-tabelas 2}
	\label{fig:resultadoInterTabelas2}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{./fig/resultados/inter-tabelas/3}
	\caption{Resultados da execução dos testes Inter-tabelas 3}
	\label{fig:resultadoInterTabelas3}
\end{figure}
